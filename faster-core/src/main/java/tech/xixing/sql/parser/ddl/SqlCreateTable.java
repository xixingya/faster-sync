...
import tech.xixing.sql.parser.ExtendedSqlNode;
...
public class SqlCreateTable extends SqlCreate implements ExtendedSqlNode {
    ...
    private final List<SqlNodeList> uniqueKeyList;
    ...
    public SqlCreateTable(
            ...
            List<SqlNodeList> uniqueKeyList,
    ...
    public SqlCreateTable(
        ...
        this.comment = comment;
        this.sideFlag = false;
        this.eventTimeField = null;
        this.maxOutOrderless = null;
    }
        ...
        if (columnList != null) {
            for (SqlNode column : columnList) {
                ...
                if (column instanceof SqlTableColumn) {
                    ...
                    columnName = tableColumn.operand(1).toString();
                }
    ...
    public static class TableCreationContext {
        ...
        public List<SqlNodeList> uniqueKeysList;
    }
    ...
    public List<SqlNodeList> getUniqueKeyList() {
    ...
    public void setEventTimeField(SqlIdentifier eventTimeField) {
        this.eventTimeField = eventTimeField;
    }

    public void setMaxOutOrderless(SqlNode maxOutOrderless) {
        this.maxOutOrderless = maxOutOrderless;
    }
}
