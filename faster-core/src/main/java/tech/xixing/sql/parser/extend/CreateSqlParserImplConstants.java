/* Generated By:JavaCC: Do not edit this line. CreateSqlParserImplConstants.java */
package tech.xixing.sql.parser.extend;

public interface CreateSqlParserImplConstants {
  ...
  int DRAIN = 693;
  int ENFORCED = 694;
  int ESTIMATED_COST = 695;
  int EXTENDED = 696;
  int FUNCTIONS = 697;
  int IF = 698;
  int JSON_EXECUTION_PLAN = 699;
  int JAR = 700;
  int JARS = 701;
  int JOB = 702;
  int LOAD = 703;
  ...
  int WATERMARK = 723;
  int WATERMARKS = 724;
  int TIMESTAMP_LTZ = 725;
  int TRY_CAST = 726;
  int ANALYZE = 727;
  int COMPUTE = 728;
  int STATISTICS = 729;
  int UNSIGNED_INTEGER_LITERAL = 730;
  int APPROX_NUMERIC_LITERAL = 731;
  int DECIMAL_NUMERIC_LITERAL = 732;
  int EXPONENT = 733;
  int HEXDIGIT = 734;
  int WHITESPACE = 735;
  int BINARY_STRING_LITERAL = 736;
  int QUOTED_STRING = 737;
  int PREFIXED_STRING_LITERAL = 738;
  int UNICODE_STRING_LITERAL = 739;
  int CHARSETNAME = 740;
  int BIG_QUERY_DOUBLE_QUOTED_STRING = 741;
  int BIG_QUERY_QUOTED_STRING = 742;
  int UNICODE_QUOTED_ESCAPE_CHAR = 743;
  int LPAREN = 744;
  int RPAREN = 745;
  int LBRACE_D = 746;
  int LBRACE_T = 747;
